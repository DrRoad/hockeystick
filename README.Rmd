...
You may alternatively install the development version of `hockeystick` from [https://github.com/cortinah/hockeystick](https://github.com/cortinah/hockeystick) with:
